...
-- ------------------------------------------------------------
-- 种子管理员用户（密码在启动时由 AdminBootstrapRunner 从 env 生成）
-- 邮箱：whj1539327601@gmail.com
-- ------------------------------------------------------------
INSERT INTO users (id, email, password_hash, display_name, role, enabled)
VALUES (1, 'whj1539327601@gmail.com', 'BOOTSTRAP', 'Admin', 'ADMIN', 1)
