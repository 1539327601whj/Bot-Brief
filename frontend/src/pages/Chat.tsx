  ...
  return (
    <div className="chat-container">
      ...
      <header className="chat-header">
        ...
        <div className="header-subtitle">{canSeePublicDigest ? '按主题检索科技日报与市场观察，再据此回答' : '按你勾选的主题和市场观察检索，再据此回答'}</div>
      </header>
      ...
      <div className="chat-messages">
        {messages.length === 0 && !loading && (
          <div className="welcome">
            ...
            <h2>你好！我是 AI 小助手</h2>
            <p>{canSeePublicDigest ? '先定位对应主题的科技日报或行情简报，再据此回答。也可以接着追问。' : '先从你勾选的主题简报或行情简报里找依据，再据此回答。也可以接着追问。'}</p>
